...
DbCenter.prototype._initMg = function(cb)
{
    ...
    var gamePermission = new Table(db, "gamePermission", [
        ...
        new Column(db, "salePermission", "varchar", 32, false, undefined),
    ]);
...
DbCenter.prototype._initMain = function(cb)
{
    ...
    var tticket = new Table(db, "tticket", [
        ...
        new Column(db, "printTime", "date", -1, false, undefined), //打印时间
        new Column(db, "cashTime", "date", -1, false, undefined), //兑奖时间
        new Column(db, "prizeTime", "date", -1, false, undefined), //返奖时间
        new Column(db, "status", "int", 11, false, -1), //状态
