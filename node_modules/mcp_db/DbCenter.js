...
DbCenter.prototype.init = function(cb)
{
    ...
    async.waterfall([
        ...
        //the oldmysql
        function(cb){
            /*self._initOldMain(function(err){
                cb(err);
            });*/
	    cb(null);
        },
...
DbCenter.prototype.check = function(cb)
{
    ...
    async.waterfall([
        ...
        //check the oldmysql
        function(cb){
            self._checkOldMain(function(err){
                cb(err);
            });
        },
    ], function (err, result) {
...
DbCenter.prototype._checkOldMain = function(cb)
{
    var self = this;
    cb(null);
};
...
DbCenter.prototype._initOldMain = function(cb)
{
    var self = this;
    var db = new Database(prop.oldMain);
    var torder = new Table(db, "torder", [
        new Column(db, "id", "bigint", -1, false, undefined, true, false),
        new Column(db, "createTime", "date", -1, false, undefined), //创建时间
        new Column(db, "amount", "bigint", -1, false, 0),   //订单金额
