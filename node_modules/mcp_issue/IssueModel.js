...
IssueModel.prototype.prize = function(msg, dTerm, cb)
{
    ...
    async.waterfall([
        ...
        function(cb)
        {
            var sql = "select customerId,count(*) as hitCount,sum(amount) as hitAmount,sum(bonus) as bonus,sum(bonusBeforeTax) as bonusBeforeTax from tticket where status=1200 group by customerId";
        ...
        function(cb)
        {
            var sql = "select customerId,count(*) as notHitCount,sum(amount) as notHitAmount from tticket where status=1300 group by customerId";
            conn.execute(sql, {}, function(err, data){
                for(var key in data)
                {
                    var set = data[key];
        ...
        function(cb)
        {
            var sql = "select customerId,count(*) as failCount,sum(amount) as failAmount from tticket where status=1400 group by customerId";
            conn.execute(sql, {}, function(err, data){
                for(var key in data)
                {
                    var set = data[key];
        ...
        function(cb)
        {
            var sql = "select printId as customerId,count(*) as hitCount,sum(amount) as hitAmount,sum(bonus) as bonus,sum(bonusBeforeTax) as bonusBeforeTax from tticket where status=1200 group by printId";
            conn.execute(sql, {}, function(err, data){
                for(var key in data)
                {
                    var set = data[key];
        ...
        function(cb)
        {
            var sql = "select printId as customerId,count(*) as notHitCount,sum(amount) as notHitAmount from tticket where status=1300 group by printId";
            conn.execute(sql, {}, function(err, data){
                for(var key in data)
                {
                    var set = data[key];
        ...
        function(cb)
        {
            var sql = "select printId as customerId,count(*) as failCount,sum(amount) as failAmount from tticket where status=1400 group by printId";
            conn.execute(sql, {}, function(err, data){
                for(var key in data)
                {
                    var set = data[key];
