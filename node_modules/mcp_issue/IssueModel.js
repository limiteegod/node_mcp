...
IssueModel.prototype.check = function(msg, dTerm, cb)
{
    ...
    async.waterfall([
        ...
        //遍历每一条记录
        //update 处理模式 1.先处理通知消息 2. 插入临时表 3. 最后更新未中奖在所有队列处理完成,也就是反奖的时候处理
...
IssueModel.prototype.prize = function(msg, dTerm, cb)
{
    ...
    async.waterfall([
        //跟新中奖
        function (cb) {
            var sql = "UPDATE tticket a INNER JOIN hitticket b on  a.id = b.id SET a.bonus = b.bonus,a.bonusDetail = b.bonusDetail ,a.bonusBeforeTax=b.bonusBeforeTax,a.auditTermCode=b.bonusBeforeTax,a.dNumber=b.dNumber,a.status=b.status";
