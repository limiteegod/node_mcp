                        ...
                        if(ticket)
                        {
                            ...
                            self.sendMsg(ticket, bonusInfo, function(err, data){
                                ...
                                if(ticket.bonus > 0){
                                    ...
                                    var split = "@";
                                    strB.append(ticket.id).append(split).append(ticket.bonus).append(split).append(JSON.stringify(ticket.bonusDetail)|| '""').append(split).append(ticket.bonusBeforeTax).append(split).append(ticket.auditTermCode).append(split).append(ticket.dNumber).append(split).append(ticketStatus.HIT);
