...
IssueModel.prototype.prize = function(msg, dTerm, cb)
{
    ...
    async.waterfall([
        //跟新中奖
        function (cb) {
            var sql = "UPDATE tticket a INNER JOIN hitticket b on  a.id = b.id SET a.bonus = b.bonus,a.bonusDetail = b.bonusDetail ,a.bonusBeforeTax=b.bonusBeforeTax,a.auditTermCode=b.auditTermCode,a.dNumber=b.dNumber,a.status=b.status";
