...
ChannelQueryControl.prototype.handleCQ01 = function(user, headNode, bodyNode, cb)
{
    ...
    if(backBodyNode.limit > 20)
    {
        backBodyNode.limit = 20;
    }
    var cols = {id:1, gameCode:1, code:1, nextCode:1, openTime:1, closeTime:1,
        status:1, pool:1, wNum:1};
    async.waterfall([
        function(cb)
        {
...
ChannelQueryControl.prototype.handleCQ03 = function(user, headNode, bodyNode, cb)
{
    ...
    province:1, seq:1, terminal:1, printId:1};
    async.waterfall([
        function(cb)
        {
            var cursor = table.find(backBodyNode.cond, cols, []).sort(backBodyNode.sort).limit(backBodyNode.skip, backBodyNode.limit);
...
ChannelQueryControl.prototype.handleCQ05 = function(user, headNode, bodyNode, cb)
{
    ...
    var cols = {
        gameCode:1, termCode:1, type:1, hitCount:1, hitAmount:1, bonus:1,
        bonusBeforeTax:1, notHitCount:1, notHitAmount:1, failCount:1,
        failAmount:1, createTime:1
    };
