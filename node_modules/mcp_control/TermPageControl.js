...
TermPageControl.prototype.list = function(headNode, bodyNode, cb)
{
    ...
    backBodyNode.termStatus = termStatusForPage.getInfoById();
    ...
    else
    {
        ...
        if(backBodyNode.cond.status==undefined){
            backBodyNode.cond.status = {$gte:termStatusForPage["PRE_ON_SALE"], $lte:termStatusForPage["PAYOUT"]};
        }
