...
Validate.prototype.validate3007 = function(order, ticket, cb) {
    ...
    if(!mathUtil.isMinAndMaxBetween(firstArray, 0, 11)){
        cb(ec.E2066);
        return;
    }
    if(!mathUtil.isMinAndMaxBetween(secondArray, 0, 11)){
        cb(ec.E2066);
        return;
    }
...
Validate.prototype.validate3102 = function(order, ticket, cb){
    ...
    if (!mathUtil.isMinAndMaxBetween(tuoArray, 0, 11)) {
        cb(ec.E2066);
        return;
    }
    ...
    if (!mathUtil.isMinAndMaxBetween(danArray, 0, 11)) {
        cb(ec.E2066);
        return;
    }
...
Validate.prototype.validate3203 = function(order, ticket, cb){
    ...
    var count = 0
    for(var key in intArray){
        count += 6*self.qszxHeZhiList[key];
    }
    if(count < 1){
        cb(ec.E2066);
        return;
...
Validate.prototype.validate3206 = function(order, ticket, cb){
    ...
    var count = 0
    for(var key in intArray){
        count += 6*self.qszxKuaDuList[key];
    }
    if(count < 1){
        cb(ec.E2066);
        return;
...
Validate.prototype.validate3207 = function(order, ticket, cb) {
    var self = this;
    var number = ticket.number;
    var reg = /^\d{2}(,\d){0,9}(\|\d{2}(,\d{2}){0,9}){2}$/;
    if(!reg.test(number)){
        log.info("正则表达式校验不通过");
        cb(ec.E2066);
        return;
    ...
    if(mathUtil.getHitCount(threeArray, secondArray) > 0 ){
        cb(ec.E2066);
        return;
    }
    if(!mathUtil.isMinAndMaxBetween(firstArray, 0 ,11)){
