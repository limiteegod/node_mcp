var TermStatus = function(){
    ...
    self.info = [{id:1000, code:'INIT', des:'初始状态'},
        ...
        {id:1425, code:'PRE_SEND', des:'后台销售结束中'},
        ...
        {id:1500, code:'DRAW', des:'已开奖'},
        {id:1600, code:'IN_CALCULATE', des:'算奖中'},
        {id:1601, code:'CALCULATE', des:'已算奖'},
        {id:1602, code:'CALCULATE_AUDITED', des:'算奖已审核'},
        {id:1603, code:'CALCULATE_AUDITED_FAILED', des:'算奖已审核失败'},
        {id:1650, code:'IN_PAYOUT', des:'返奖中'},
        {id:1675, code:'OUTER_FILE', des:'已经生成外部文件'},
        {id:1701, code:'PAYOUT', des:'已返奖'},
        {id:1800, code:'IN_SETTLEMENT', des:'结算中'},
        {id:1801, code:'SETTLEMENT', des:'已结算'},
        {id:1900, code:'IN_SEAL', des:'期次封存中'},
        {id:1901, code:'SEAL', des:'期次已封存'}];
    self.infoArray = {};
    self.init();
};
