...
DanTuoNum::DanTuoNum(char *pNum, int len)
{
       ...
       if(preDanFlag > 0){
         IntArray* ia = new IntArray(16, preChar, preDanFlag  , ','); //取出$之前的是胆码
         this->preDanArray = ia;
         IntArray* tuo = new IntArray(16,preChar + preDanFlag +1  , jcount - preDanFlag -1 , ',');
         this->preTuoArray = tuo;
       }else{
         IntArray* ia = new IntArray(0);
         this->preDanArray = ia;
         IntArray* tuo = new IntArray(30,preChar, jcount, ',');
         this->preTuoArray = tuo;
       }
       if(afterDanFlag > 0){
         IntArray* ia2 = new IntArray(16, afterChar, afterDanFlag , ','); //取出$之前的是胆码
         this->afterDanArray = ia2;
         IntArray* tuo2 = new IntArray(16, afterChar + afterDanFlag +1  , acount - afterDanFlag -1 , ',');
         this->afterTuoArray = tuo2;
       }else{
         IntArray* ia2 = new IntArray(0);
         this->afterDanArray = ia2;
         IntArray* tuo2 = new IntArray(30, afterChar, acount, ',');
         this->afterTuoArray = tuo2;
       }
       delete[] preChar;
       delete[] afterChar;
