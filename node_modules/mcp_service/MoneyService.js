...
MoneyService.prototype.handle = function(customerId, orderId, roleCode, accountCode, typeCode, subjectCode, amount, cb)
{
    var self = this;
...
MoneyService.prototype.handleById = function(customerId, orderId, roleId, accountId, typeId, subjectId, amount, cb)
{
    var self = this;
