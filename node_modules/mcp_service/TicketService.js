 ...
 * @param cb
 */
TicketService.prototype.newHit = function(ticket, cb)
{
    var table = dc.main.get("hitticket");
    ticket.bonus=ticket.bonus*ticket.multiple;
    ticket.bonusDetail = JSON.stringify(ticket.bonusDetail);
    ticket.bonusBeforeTax = ticket.bonusBeforeTax*ticket.multiple;
